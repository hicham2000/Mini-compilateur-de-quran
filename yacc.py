...
def p_verset1(p):
      ...
      if(p[2]=='(1)'): 
            print('AYA1 est correcte avec delimiter')
              ...
              print('erreur,il faut mettre le delimiter 1') 
...
def p_verset2(p):
      ...
      if(p[2]=='(2)'): 
            print('AYA2 est correcte avec delimiter')
              ...
              print('erreur,il faut mettre le delimiter 2') 
...
def p_verset3(p):
      ...
      if(p[2]=='(3)'): 
            print('AYA3 est correcte avec delimiter')
              ...
              print('il faut mettre le delimiter 3') 
...
def p_verset4(p):
      ...
      if(p[2]=='(4)'): 
            print('AYA4 est correcte avec delimiter')
              ...
              print('il faut mettre le delimiter 4') 
...
def p_verset5(p):
      ...
      if(p[2]=='(5)'): 
            print('AYA5 est correcte avec delimiter')
              ...
              print('il faut mettre le delimiter 5') 
...
def p_verset6(p):
      ...
      if(p[2]=='(6)'): 
            print('AYA6 est correcte avec delimiter')
              ...
              print('il faut mettre le delimiter 6')
...
def p_verset7(p):
      ...
      if(p[2]=='(7)'): 
            print('AYA7 est correcte avec delimiter')
              ...
              print('il faut mettre le delimiter 7') 
...
def p_verset8(p):
      ...
      if(p[2]=='(8)'): 
            print('AYA8 est correcte avec delimiter')
              ...
              print('il faut mettre le delimiter 8') 
...
def p_verset9(p):
      ...
      if(p[2]=='(9)'): 
            print('AYA9 est correcte avec delimiter')
              ...
              print('il faut mettre le delimiter 9') 
...
def p_verset10(p):
      ...
      if(p[2]=='(10)'): 
            print('AYA10 est correcte avec delimiter')
              ...
              print('il faut mettre le delimiter 10')                             
...
def p_verset11(p):
      ...
      if(p[2]=='(11)'): 
            print('AYA11 est correcte avec delimiter')
              ...
              print('il faut mettre le delimiter 11') 
...
def p_verset12(p):
      ...
      if(p[2]=='(12)'): 
            print('AYA12 est correcte avec delimiter')
              ...
              print('il faut mettre le delimiter 12') 
...
def p_verset13(p):
      ...
      if(p[2]=='(13)'): 
            print('AYA13 est correcte avec delimiter')
              ...
              print('il faut mettre le delimiter 13')
...
def p_verset14(p):
      ...
      if(p[2]=='(14)'): 
            print('AYA14 est correcte avec delimiter')
              ...
              print('il faut mettre le delimiter 14')                              
...
def p_verset15(p):
      ...
      if(p[2]=='(15)'): 
            print('AYA15 est correcte avec delimiter')
              ...
              print('il faut mettre le delimiter 15') 
...
def p_verset16(p):
      ...
      if(p[2]=='(16)'): 
            print('AYA16 est correcte avec delimiter')
              ...
              print('il faut mettre le delimiter 16') 
...
def p_verset17(p):
      ...
      if(p[2]=='(17)'): 
            print('AYA17 est correcte avec delimiter')
              ...
              print('il faut mettre le delimiter 17') 
...
def p_verset18(p):
      ...
      if(p[2]=='(18)'): 
            print('AYA18 est correcte avec delimiter')
              ...
              print('il faut mettre le delimiter 18') 
...
def p_verset19(p):
      ...
      if(p[2]=='(19)'): 
            print('AYA19 est correcte avec delimiter')
              ...
              print('il faut mettre le delimiter 19') 
